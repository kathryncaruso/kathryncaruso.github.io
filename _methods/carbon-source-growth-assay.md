...
| --------- | ------------------------------- | ----------------------------------------------------------------------- |
| 1         | Sodium DL-malate                | C<sub>4</sub>H<sub>4</sub>Na<sub>2</sub>0<sub>5</sub>                   |
| 2         | Sodium succinate                | C<sub>4</sub>H<sub>4</sub>Na<sub>2</sub>0<sub>4</sub> · 6H<sub>2</sub>0 |
| 3         | Sodium acetate (anhydrous, 99%) | C<sub>2</sub>H<sub>3</sub>Na0<sub>2</sub>                               |
...
> [!important] Carbon source concentrations
